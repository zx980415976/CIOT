 ...
 * 实例：  
   class Account{  
   &ensp;   private AccountType _accountType;  
   &ensp;   private int _daysOverdrawn;  
      
   &ensp;   double OverdraftCharge(){  
   &ensp;&ensp;       if (_accountType.IsPremium()) {  
   &ensp;&ensp;&ensp;            double result = 10;  
   &ensp;&ensp;           if (_daysOverdrawn > 7) {  
   &ensp;&ensp;&ensp;            result += (_daysOverdrawn - 7) * 0.85;  
   &ensp;&ensp;           }  
   &ensp;           return result;  
   &ensp;       }  
   &ensp;       return _daysOverdrawn * 1.75;  
   &ensp;    }  

   &ensp;   double BankCharge(){  
   &ensp;       double result = 4.5;  
   &ensp;       if (_daysOverdrawn > 0){  
   &ensp;&ensp;           result += OverdraftCharge();  
   &ensp;       }  
   &ensp;       return result;  
   &ensp;   }  
   &ensp; }  
